			...
			<div class="content d-flex flex-column align-items-center" style="height: 600px; margin-top: 70px;'); ">
                ...
                <div class="border border-danger w-75 h-75 my-5 d-flex flex-row  justify-content-between">
                  <div class="d-flex w-50">
                    <div class="border border-danger m-auto h-50 w-50 d-flex align-items-center justify-content-center"><h5 style="color: gray">gambar</h5></div>
                  </div>
                  <div class="border border-danger"></div>
                  <form action="crud_add.php" method="post" name="form1" class=" d-flex flex-column  w-50 my-5">
                    <input class="my-3 mx-auto rounded-3 w-75" style="height: 25%; border: 1px solid #cc0000" placeholder="Nama" type="text" name="nama" />
                    <input class="my-3 mx-auto rounded-3 w-75" style="height: 25%; border: 1px solid #cc0000" placeholder="Harga" type="text" name="harga" />
                    <input class="my-3 mx-auto rounded-3 w-75" style="height: 25%; border: 1px solid #cc0000" placeholder="Gambar" type="text" name="gambar" />
                    <input class="w-50 my-3 mx-auto rounded-5 text-white fw-bold fs-5" style="height: 25%; background-color: #cc0000" type="submit" name="Submit" value="Tambah" />
                  </form>
                </div>
			</div>
